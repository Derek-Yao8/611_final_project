...
```
Here is a summary table of the base statistics across all League of Legends champion. Mana is the resource some champions use to cast abilities, all the growth statistics are how much that stat grows with each level increase, and armor and magic resist are defensive statistics.

We see that values of certain stats, 
